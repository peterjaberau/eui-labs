...
import ConfigurableDashboardApp from "@/lab/pages/configurable-dashboard";
import {EuiApp} from "@/lab/eui";
import KibanaApp from "@/lab/kibana";
    ...
    >
      <Route path="" element={<AppInitPage />}>
        <Route path="" element={<AppWrapperPage />}>
          ...
          <Route path="config-dashboard" element={<ConfigurableDashboardApp />} />
          <Route path="eui" element={<EuiApp />} />
          <Route path="kibana" element={<KibanaApp />} />
